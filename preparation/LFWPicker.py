...
output_path = '../data/'
# use the dataset_path='path to existing lfw directory' to use an existing lfw dataset if downloading doesn't work.
picker = LFWPicker(dataset_path=None, output_path=output_path)
