...
def detect_face(img, detector_backend = 'opencv', grayscale = False, enforce_detection = False, align = True):
...
def preprocess_face(img, target_size=(224, 224), grayscale = False, enforce_detection = False, detector_backend = 'opencv', return_region = False, align = True):
